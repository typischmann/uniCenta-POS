...
public class ThirdPartiesView extends javax.swing.JPanel implements EditorRecord {
    ...
    private void initComponents() {
        ...
        m_jCIF.setFont(new java.awt.Font("MS Song", 0, 12)); // NOI18N
        add(m_jCIF);
        ...
        m_jContactComm.setFont(new java.awt.Font("MS Song", 0, 12)); // NOI18N
        add(m_jContactComm);
        ...
        m_jContactFact.setFont(new java.awt.Font("MS Song", 0, 12)); // NOI18N
        add(m_jContactFact);
        ...
        m_jPayRule.setFont(new java.awt.Font("MS Song", 0, 12)); // NOI18N
        add(m_jPayRule);
        ...
        m_jFaxNumber.setFont(new java.awt.Font("MS Song", 0, 12)); // NOI18N
        add(m_jFaxNumber);
        ...
        m_jPhoneNumber.setFont(new java.awt.Font("MS Song", 0, 12)); // NOI18N
        add(m_jPhoneNumber);
        ...
        m_jMobileNumber.setFont(new java.awt.Font("MS Song", 0, 12)); // NOI18N
        add(m_jMobileNumber);
        ...
        m_jEMail.setFont(new java.awt.Font("MS Song", 0, 12)); // NOI18N
        add(m_jEMail);
        ...
        m_jWebPage.setFont(new java.awt.Font("MS Song", 0, 12)); // NOI18N
        add(m_jWebPage);
        ...
        jScrollPane2.setFont(new java.awt.Font("MS Song", 0, 12)); // NOI18N
        ...
        jLabel14.setFont(new java.awt.Font("MS Song", 1, 12)); // NOI18N
        ...
        jLabel15.setFont(new java.awt.Font("MS Song", 1, 12)); // NOI18N
        ...
        jLabel16.setFont(new java.awt.Font("MS Song", 1, 12)); // NOI18N
